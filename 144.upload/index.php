    ...
    <div class="container">
      <form action="" method="POST">
        <div class="row height d-flex justify-content-center align-items-center">
          <div class="col-md-8">
            <div class="search"> <i class="fa fa-search"></i> <input type="text" class="form-control" placeholder="Search" name="keyword" autofocus autocomplete="off"> <button class="btn btn-primary" name="cari">Search</button> </div>
          </div>
        </div>
      </form>
